...
This outlines how to propose a change to IncubationPeriodModels. For a
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("NyallJamieson/IncubationPeriodModels", fork = TRUE)`.
...
[Contributor Code of
Conduct](https://nyalljamieson.github.io/IncubationPeriodModels/CODE_OF_CONDUCT.md).

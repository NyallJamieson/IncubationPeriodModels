...
[![R-CMD-check](https://github.com/NyallJamieson/IncubationPeriodModels/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/NyallJamieson/IncubationPeriodModels/actions)
[![License:
MIT](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)
[![R-CMD-check](https://github.com/NyallJamieson/IncubationPeriodModels/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/NyallJamieson/IncubationPeriodModels/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
